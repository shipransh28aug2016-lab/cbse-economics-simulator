...
if (typeof I18N_HI === 'undefined') {
    var I18N_HI = {
        ...
        'tlm.examTip': '📝 परीक्षा सुझाव',
        'tlm.thinkQuestion': '🤔 सोचिए',
        'tlm.activity': '🎬 गतिविधि',
        'tlm.quickCheck': '✅ त्वरित जाँच',
        'tlm.exitTicket': '🎫 एग्ज़िट टिकट',
        'tlm.teacherExplain': '🧑‍🏫 शिक्षकों के लिए',
        'quiz.correct': '✅ सही जवाब!',
        'quiz.incorrect': '❌ यह सही नहीं है।',
